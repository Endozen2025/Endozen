...
import { ArrowRight, Shield, Clock, Users, CheckCircle, Star, Phone, Award, Wrench, Settings, Target, Truck, Search, FileText } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                <p>
                  At EndoZen, we take a precision-centered approach to endoscope repair and lifecycle management. We
                  understand the daily challenges faced by hospitals, clinics, and diagnostic centers - delayed repairs,
                  inconsistent service quality, and rising costs.
                </p>
                <p>
                  That's why we offer accurate, affordable, and dependable repair solutions for flexible endoscopes across
                  India. Every device we service undergoes strict quality control to ensure optimal performance and full
              ...
              <div className="mt-8 grid md:grid-cols-2 gap-6">
                <div className="bg-blue-50 p-6 rounded-xl">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">Precision-Centered</h3>
                  <p className="text-gray-600 text-sm">Every repair follows strict protocols for optimal performance</p>
                </div>
                <div className="bg-green-50 p-6 rounded-xl">
                  <Shield className="h-8 w-8 text-green-600 mb-3" />
                  <h3 className="font-semibold text-gray-900 mb-2">Quality Control</h3>
                  <p className="text-gray-600 text-sm">Comprehensive testing ensures healthcare compliance</p>
                </div>
              </div>
              ...
              <div className="mt-8 bg-gradient-to-r from-blue-600 to-green-600 text-white p-6 rounded-xl">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold">Nationwide Pickup & Delivery Available</h3>
                </div>
                <p className="text-blue-100">
                  Convenient logistics support across India for seamless service experience
                </p>
              </div>
            </div>
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-sm p-6 rounded-lg">
                ...
                <div className="space-y-2">
                  <div className="flex items-center text-gray-600">
                    ...
                    <span className="text-sm">Accurate & affordable solutions</span>
                  </div>
                  <div className="flex items-center text-gray-600">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                  ...
                  <div className="flex items-center text-gray-600">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                    <span className="text-sm">Healthcare standards compliance</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Whether you're a small clinic or a large hospital network, EndoZen is here to support your
              equipment so you can stay focused on delivering exceptional patient care.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Extend Equipment Lifespan</h3>
              <p className="text-gray-600 mb-6">
                Our precision repair and maintenance services significantly extend the lifespan of your endoscopy equipment, maximizing your investment.
              </p>
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Minimize Downtime</h3>
              <p className="text-gray-600 mb-6">
                Improve device availability and minimize downtime with our fast turnaround times and preventive maintenance programs.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 mb-6">
                Access expert guidance and responsive technical support with tailored service contracts and nationwide logistics.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Reduce Disruptions</h3>
              <p className="text-gray-600 mb-6">
                Reduce operational disruptions with our comprehensive maintenance programs and proactive equipment monitoring.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 md:col-span-2 lg:col-span-1">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Affordable Solutions</h3>
              <p className="text-gray-600 mb-6">
                Get accurate, affordable, and dependable repair solutions with transparent pricing and comprehensive warranties.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
            ...
            {[
              {
                ...
                description: 'Expert repair of flexible endoscopes including gastroscopes, colonoscopes, and bronchoscopes with precision tools and high-grade components.',
                features: ['Video endoscope repair', 'Light guide cable service', 'Insertion tube replacement'],
                icon: Wrench,
                image: 'https://images.pexels.com/photos/4167541/pexels-photo-4167541.jpeg?auto=compress&cs=tinysrgb&w=300&h=150&fit=crop'
              },
              {
                title: 'Preventive Maintenance',
                description: 'Scheduled maintenance programs to prevent costly breakdowns and extend equipment life with comprehensive testing.',
                features: ['Regular inspections', 'Performance testing', 'Compliance certification'],
                icon: Settings,
                image: 'https://images.pexels.com/photos/4386467/pexels-photo-4386467.jpeg?auto=compress&cs=tinysrgb&w=300&h=150&fit=crop'
              },
              {
                title: 'Emergency Service',
                description: '24/7 emergency repair service to minimize downtime and keep your facility operational with same-day response.',
                features: ['Same-day response', 'On-site service', 'Loaner equipment'],
                icon: Clock,
                image: 'https://images.pexels.com/photos/4021775/pexels-photo-4021775.jpeg?auto=compress&cs=tinysrgb&w=300&h=150&fit=crop'
              }
            ].map((service, index) => (
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <blockquote className="text-2xl md:text-3xl font-light mb-8 max-w-4xl mx-auto">
              "EndoZen has been our trusted partner for over 5 years. Their expertise and reliability have kept our endoscopy department running smoothly with minimal downtime."
            </blockquote>
            <div className="text-lg">
              <p className="font-semibold">Dr. Sarah Johnson</p>
              <p className="opacity-90">Chief of Gastroenterology, Metropolitan Medical Center</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get a free quote today and experience the EndoZen difference. Fast, reliable, and professional service guaranteed.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/quote"
